...
write.csv(results_E, file.path(deg_path, "results_E_minus_vs_E_plus.csv"))

# For timepoint B
results_B <- topTags(qlf_B, n = Inf)$table
write.csv(results_B, file.path(deg_path, "results_B_minus_vs_B_plus.csv"))

# For timepoint D
results_D <- topTags(qlf_D, n = Inf)$table
write.csv(results_D, file.path(deg_path, "results_D_minus_vs_D_plus.csv"))

# For timepoint G
results_G <- topTags(qlf_G, n = Inf)$table
write.csv(results_G, file.path(deg_path, "results_G_minus_vs_G_plus.csv"))

# For timepoint C
results_C <- topTags(qlf_C, n = Inf)$table
write.csv(results_C, file.path(deg_path, "results_C_minus_vs_C_plus.csv"))

# For timepoint F
results_F <- topTags(qlf_F, n = Inf)$table
write.csv(results_F, file.path(deg_path, "results_F_minus_vs_F_plus.csv"))
